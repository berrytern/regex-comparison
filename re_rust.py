...
compiled_reru_time_is_match = timeit("process_is_match(r'BRAHMA DUPLO MALTE LT 310ML SH C/15 MULT', r'LATA 310 ML')", number=times, setup="""
from reru import ReRu as re
RE_BRAHM0 = re.compile(r"BRAHM")
RE_BRAHM1 = re.compile(r"TOST")
RE_BRAHM2 = re.compile(r"ESCU")
...
# print(process('BRAHMA DUPLO MALTE LT 310ML SH C/15 MULT', 'LATA 310 ML'))
print("reru compiled is_match time:")
print(f'{compiled_reru_time_is_match*1000}ms')
# print(process('BRAHMA DUPLO MALTE LT 310ML SH C/15 MULT', 'LATA 310 ML'))
